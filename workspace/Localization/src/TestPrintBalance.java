...
public class TestPrintBalance {
	...
	public void testFrench(){
		...
		assertEquals("Enchanté, " + name,printer.nameString(name));
		assertEquals("En date du : 31 décembre 1969",printer.dateString(today));
		assertEquals("Vous devez l'école 9 876 543,21 €",printer.owed(9876543.21));
